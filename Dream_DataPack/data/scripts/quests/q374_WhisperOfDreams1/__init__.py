...
#Updated by RusTeam
import sys
from com.dipedro import Config
...
def render_shop() :
    ...
    for i in SHOP_LIST.keys() :
       ...
       html += "<tr><td><a action=\"bypass -h Quest q374_WhisperOfDreams1 "+str(i)+"\"><font color=\"FFFFFF\">"+SHOP_LIST[i][3]+" x"+str(SHOP_LIST[i][1])+"</font></a></td></tr>"
       html += "<tr><td><a action=\"bypass -h Quest q374_WhisperOfDreams1 "+str(i)+"\"><font color=\"B09878\">"+str(SHOP_LIST[i][2]*ADENA_X)+" adena</font></a></td></tr></table></td></tr>"
...
QUEST       = Quest(374, qn, "Whisper of Dreams, part 1")
