 ...
 */
package com.dipedro.gameserver.model.actor;

import static com.dipedro.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.dipedro.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.dipedro.gameserver.datatables.xml.MapRegionTable.TeleportWhereType;
import com.dipedro.gameserver.datatables.xml.NpcTable;
import com.dipedro.gameserver.geo.GeoData;
import com.dipedro.gameserver.geo.pathfinding.Node;
import com.dipedro.gameserver.geo.pathfinding.PathFinding;
import com.dipedro.gameserver.geo.util.Door;
...
import com.dipedro.gameserver.managers.TownManager;
import com.dipedro.gameserver.model.ChanceSkillList;
import com.dipedro.gameserver.model.CharEffectList;
import com.dipedro.gameserver.model.ForceBuff;
...
import com.dipedro.gameserver.model.actor.instance.L2BoatInstance;
import com.dipedro.gameserver.model.actor.instance.L2ControlTowerInstance;
...
import com.dipedro.gameserver.model.actor.instance.L2FlameTowerInstance;
import com.dipedro.gameserver.model.actor.instance.L2FriendlyMobInstance;
import com.dipedro.gameserver.model.actor.instance.L2GrandBossInstance;
import com.dipedro.gameserver.model.actor.instance.L2GuardInstance;
import com.dipedro.gameserver.model.actor.instance.L2ItemInstance;
import com.dipedro.gameserver.model.actor.instance.L2MinionInstance;
import com.dipedro.gameserver.model.actor.instance.L2MonsterInstance;
import com.dipedro.gameserver.model.actor.instance.L2NpcInstance;
import com.dipedro.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.dipedro.gameserver.model.actor.instance.L2PcInstance;
import com.dipedro.gameserver.model.actor.instance.L2PcInstance.SkillDat;
import com.dipedro.gameserver.model.actor.instance.L2PetInstance;
import com.dipedro.gameserver.model.actor.instance.L2RaidBossInstance;
import com.dipedro.gameserver.model.actor.instance.L2RiftInvaderInstance;
import com.dipedro.gameserver.model.actor.instance.L2SiegeFlagInstance;
import com.dipedro.gameserver.model.actor.instance.L2SiegeGuardInstance;
import com.dipedro.gameserver.model.actor.instance.L2SiegeSummonInstance;
import com.dipedro.gameserver.model.actor.instance.L2SummonInstance;
import com.dipedro.gameserver.model.actor.knownlist.CharKnownList;
import com.dipedro.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
import com.dipedro.gameserver.model.actor.position.L2CharPosition;
import com.dipedro.gameserver.model.actor.stat.CharStat;
import com.dipedro.gameserver.model.actor.status.CharStatus;
...
import com.dipedro.gameserver.network.Disconnection;
import com.dipedro.gameserver.network.SystemMessageId;
import com.dipedro.gameserver.network.serverpackets.ActionFailed;
import com.dipedro.gameserver.network.serverpackets.Attack;
import com.dipedro.gameserver.network.serverpackets.BeginRotation;
import com.dipedro.gameserver.network.serverpackets.ChangeMoveType;
...
import com.dipedro.gameserver.network.serverpackets.CharMoveToLocation;
import com.dipedro.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import com.dipedro.gameserver.network.serverpackets.FlyToLocation;
import com.dipedro.gameserver.network.serverpackets.FlyToLocation.FlyType;
import com.dipedro.gameserver.network.serverpackets.L2GameServerPacket;
import com.dipedro.gameserver.network.serverpackets.MagicEffectIcons;
import com.dipedro.gameserver.network.serverpackets.MagicSkillCanceld;
...
import com.dipedro.gameserver.network.serverpackets.NpcInfo;
import com.dipedro.gameserver.network.serverpackets.PartySpelled;
import com.dipedro.gameserver.network.serverpackets.PetInfo;
import com.dipedro.gameserver.network.serverpackets.RelationChanged;
import com.dipedro.gameserver.network.serverpackets.Revive;
...
import com.dipedro.gameserver.network.serverpackets.TeleportToLocation;
import com.dipedro.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.dipedro.gameserver.skills.Calculator;
...
import com.dipedro.gameserver.skills.funcs.Func;
import com.dipedro.gameserver.taskmanager.AttackStanceTaskManager;
import com.dipedro.gameserver.templates.StatsSet;
import com.dipedro.gameserver.templates.chars.L2CharTemplate;
