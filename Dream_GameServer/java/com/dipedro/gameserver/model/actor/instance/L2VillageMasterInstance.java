...
import com.dipedro.gameserver.Shutdown;
...
import com.dipedro.gameserver.model.L2Clan.SubPledge;
import com.dipedro.gameserver.model.L2ClanMember;
import com.dipedro.gameserver.model.L2PledgeSkillLearn;
...
import com.dipedro.gameserver.model.base.ClassType;
import com.dipedro.gameserver.model.base.PlayerClass;
import com.dipedro.gameserver.model.base.PlayerRace;
...
import com.dipedro.gameserver.network.serverpackets.AquireSkillList;
...
public final class L2VillageMasterInstance extends L2NpcInstance
{
	...
	public void changeClanLeader(L2PcInstance player, String target)
	{
		...
		if (player.getSiegeState() < 2)
        {
                player.sendMessage("Clan leadership cannot be transferred to another player during the siege.");
                return;
        }
