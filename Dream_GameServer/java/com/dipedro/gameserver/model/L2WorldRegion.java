			...
			for(L2Object o : _visibleObjects)
			{
				if(o instanceof L2Attackable)
				{
					...
					if(mob.getAI()!=null){
						...
						mob.getAI().setIntention(com.dipedro.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
