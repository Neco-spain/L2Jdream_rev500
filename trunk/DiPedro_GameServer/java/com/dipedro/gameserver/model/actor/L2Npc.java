...
import static com.dipedro.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
...
import com.dipedro.gameserver.managers.CustomNpcInstanceManager;
...
import com.dipedro.gameserver.model.L2DropCategory;
import com.dipedro.gameserver.model.L2DropData;
import com.dipedro.gameserver.model.L2NpcAIData;
...
import com.dipedro.gameserver.model.actor.instance.L2CastleTeleporterInstance;
import com.dipedro.gameserver.model.actor.instance.L2ControlTowerInstance;
import com.dipedro.gameserver.model.actor.instance.L2CustomNpcInstance;
import com.dipedro.gameserver.model.actor.instance.L2FestivalGuideInstance;
import com.dipedro.gameserver.model.actor.instance.L2FishermanInstance;
import com.dipedro.gameserver.model.actor.instance.L2ItemInstance;
import com.dipedro.gameserver.model.actor.instance.L2MerchantInstance;
...
import com.dipedro.gameserver.model.actor.instance.L2TeleporterInstance;
import com.dipedro.gameserver.model.actor.instance.L2WarehouseInstance;
import com.dipedro.gameserver.model.actor.knownlist.NpcKnownList;
import com.dipedro.gameserver.model.actor.stat.NpcStat;
import com.dipedro.gameserver.model.actor.status.NpcStatus;
import com.dipedro.gameserver.model.entity.Hero;
import com.dipedro.gameserver.model.entity.event.Lottery;
...
import com.dipedro.gameserver.model.multisell.L2Multisell;
...
import com.dipedro.gameserver.model.zone.type.L2TownZone;
...
import com.dipedro.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import com.dipedro.gameserver.network.serverpackets.ExShowVariationMakeWindow;
import com.dipedro.gameserver.network.serverpackets.InventoryUpdate;
import com.dipedro.gameserver.network.serverpackets.MoveToPawn;
...
import com.dipedro.gameserver.network.serverpackets.NpcSay;
import com.dipedro.gameserver.network.serverpackets.RadarControl;
...
import com.dipedro.gameserver.taskmanager.DecayTaskManager;
import com.dipedro.gameserver.templates.L2HelperBuff;
...
import com.dipedro.util.StringUtil;
