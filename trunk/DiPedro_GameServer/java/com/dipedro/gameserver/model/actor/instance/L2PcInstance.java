...
import com.dipedro.gameserver.ItemsAutoDestroy;
import com.dipedro.gameserver.RecipeController;
import com.dipedro.gameserver.ai.CtrlIntention;
import com.dipedro.gameserver.ai.L2CharacterAI;
import com.dipedro.gameserver.ai.L2PlayerAI;
import com.dipedro.gameserver.cache.HtmCache;
import com.dipedro.gameserver.communitybbs.BB.Forum;
import com.dipedro.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.dipedro.gameserver.datatables.AccessLevel;
import com.dipedro.gameserver.datatables.ClanLeaderSkillTable;
...
import com.dipedro.gameserver.model.BlockList;
import com.dipedro.gameserver.model.FishData;
import com.dipedro.gameserver.model.L2Clan;
import com.dipedro.gameserver.model.L2ClanMember;
import com.dipedro.gameserver.model.L2Effect;
import com.dipedro.gameserver.model.L2Fishing;
import com.dipedro.gameserver.model.L2Macro;
import com.dipedro.gameserver.model.L2ManufactureList;
import com.dipedro.gameserver.model.L2Object;
import com.dipedro.gameserver.model.L2Party;
import com.dipedro.gameserver.model.L2Radar;
import com.dipedro.gameserver.model.L2RecipeList;
import com.dipedro.gameserver.model.L2Request;
import com.dipedro.gameserver.model.L2ShortCut;
import com.dipedro.gameserver.model.L2Skill;
import com.dipedro.gameserver.model.L2Skill.SkillTargetType;
import com.dipedro.gameserver.model.L2SkillLearn;
import com.dipedro.gameserver.model.L2World;
import com.dipedro.gameserver.model.Location;
import com.dipedro.gameserver.model.MacroList;
...
import com.dipedro.gameserver.model.ShortCuts;
...
import com.dipedro.gameserver.model.actor.appearance.PcAppearance;
import com.dipedro.gameserver.model.actor.knownlist.PcKnownList;
import com.dipedro.gameserver.model.actor.stat.PcStat;
import com.dipedro.gameserver.model.actor.status.PcStatus;
import com.dipedro.gameserver.model.base.ClassId;
import com.dipedro.gameserver.model.base.ClassLevel;
import com.dipedro.gameserver.model.base.Experience;
import com.dipedro.gameserver.model.base.PlayerClass;
import com.dipedro.gameserver.model.base.Race;
import com.dipedro.gameserver.model.base.SubClass;
import com.dipedro.gameserver.model.entity.Announcements;
import com.dipedro.gameserver.model.entity.Duel;
...
import com.dipedro.gameserver.model.entity.siege.Siege;
import com.dipedro.gameserver.model.extender.BaseExtender.EventType;
import com.dipedro.gameserver.model.itemcontainer.Inventory;
import com.dipedro.gameserver.model.itemcontainer.ItemContainer;
import com.dipedro.gameserver.model.itemcontainer.PcFreight;
import com.dipedro.gameserver.model.itemcontainer.PcInventory;
import com.dipedro.gameserver.model.itemcontainer.PcWarehouse;
import com.dipedro.gameserver.model.itemcontainer.PetInventory;
import com.dipedro.gameserver.model.quest.Quest;
import com.dipedro.gameserver.model.quest.QuestState;
import com.dipedro.gameserver.model.zone.type.L2BossZone;
...
import com.dipedro.gameserver.network.serverpackets.ChangeWaitType;
import com.dipedro.gameserver.network.serverpackets.CharInfo;
import com.dipedro.gameserver.network.serverpackets.ConfirmDlg;
import com.dipedro.gameserver.network.serverpackets.CreatureSay;
import com.dipedro.gameserver.network.serverpackets.EtcStatusUpdate;
import com.dipedro.gameserver.network.serverpackets.ExAutoSoulShot;
import com.dipedro.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.dipedro.gameserver.network.serverpackets.ExFishingEnd;
import com.dipedro.gameserver.network.serverpackets.ExFishingStart;
import com.dipedro.gameserver.network.serverpackets.ExOlympiadMode;
import com.dipedro.gameserver.network.serverpackets.ExOlympiadUserInfo;
import com.dipedro.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.dipedro.gameserver.network.serverpackets.ExShowScreenMessage;
import com.dipedro.gameserver.network.serverpackets.ExStorageMaxCount;
import com.dipedro.gameserver.network.serverpackets.FriendList;
import com.dipedro.gameserver.network.serverpackets.HennaInfo;
...
import com.dipedro.gameserver.network.serverpackets.LeaveWorld;
...
import com.dipedro.gameserver.network.serverpackets.ObservationMode;
import com.dipedro.gameserver.network.serverpackets.ObservationReturn;
import com.dipedro.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.dipedro.gameserver.network.serverpackets.PetInventoryUpdate;
import com.dipedro.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.dipedro.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.dipedro.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.dipedro.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.dipedro.gameserver.network.serverpackets.PrivateStoreListSell;
import com.dipedro.gameserver.network.serverpackets.QuestList;
import com.dipedro.gameserver.network.serverpackets.RecipeShopSellList;
import com.dipedro.gameserver.network.serverpackets.RelationChanged;
import com.dipedro.gameserver.network.serverpackets.Ride;
import com.dipedro.gameserver.network.serverpackets.SendTradeDone;
import com.dipedro.gameserver.network.serverpackets.ServerClose;
import com.dipedro.gameserver.network.serverpackets.SetupGauge;
import com.dipedro.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.dipedro.gameserver.network.serverpackets.ShortCutInit;
import com.dipedro.gameserver.network.serverpackets.SkillCoolTime;
import com.dipedro.gameserver.network.serverpackets.SkillList;
import com.dipedro.gameserver.network.serverpackets.Snoop;
...
import com.dipedro.gameserver.network.serverpackets.TargetSelected;
import com.dipedro.gameserver.network.serverpackets.TargetUnselected;
import com.dipedro.gameserver.network.serverpackets.TitleUpdate;
import com.dipedro.gameserver.network.serverpackets.TradePressOtherOk;
import com.dipedro.gameserver.network.serverpackets.TradePressOwnOk;
import com.dipedro.gameserver.network.serverpackets.TradeStart;
...
import com.dipedro.gameserver.skills.effects.EffectCharge;
import com.dipedro.gameserver.templates.chars.L2PcTemplate;
import com.dipedro.gameserver.templates.item.L2Armor;
import com.dipedro.gameserver.templates.item.L2ArmorType;
import com.dipedro.gameserver.templates.item.L2EtcItem;
import com.dipedro.gameserver.templates.item.L2EtcItemType;
import com.dipedro.gameserver.templates.item.L2Henna;
...
import com.dipedro.gameserver.util.IllegalPlayerAction;
import com.dipedro.gameserver.util.Util;
import com.dipedro.util.CloseUtil;
import com.dipedro.util.ResourceUtil;
				...
				if(pk == null || !pk.isCursedWeaponEquiped())
				{
					...
					if(!(isInsideZone(ZONE_PVP) && !isInsideZone(ZONE_SIEGE)))
					{
						...
						if(isKillerPc && ((L2PcInstance) killer).getClan() != null && getClan() != null && !isAcademyMember() && !((L2PcInstance) killer).isAcademyMember() && _clan.isAtWarWith(((L2PcInstance) killer).getClanId()) && ((L2PcInstance) killer).getClan().isAtWarWith(_clan.getClanId()))
						{
							...
							{
								((L2PcInstance) killer).getClan().addReputationScore(((L2PcInstance) killer).getClan().getReputationScore() + 1, true);
							}

							if(((L2PcInstance) killer).getClan().getReputationScore() > 0)
							{
								_clan.addReputationScore(_clan.getReputationScore() - 1, true);
							}
						}
