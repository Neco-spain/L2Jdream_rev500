...
public class Die extends L2GameServerPacket
{
	...
	private boolean _inEventFOS;
	private boolean _inEventTvT;
	private boolean _inEventVIP;
	private AccessLevel _access = AccessLevels._userAccessLevel;
	private com.dipedro.gameserver.model.L2Clan _clan;
	...
	{
		if(_fake || _inEventCTF || _inEventDM || _inEventFOS || _inEventTvT || _inEventVIP)
		{
			return;
		}
