 ...
 */
package com.dipedro.gameserver.model.entity.sevensigns;
...
import com.dipedro.gameserver.model.spawn.SpawnListener;
...
public class SevenSignsFestival implements SpawnListener
{
	...
	private void addReputationPointsForPartyMemberClan(String partyMemberName)
	{
		...
		if(player != null)
		{
			...
			{
				player.getClan().addReputationScore(player.getClan().getReputationScore() + 100, true);
			...
			try
			{
				...
				if(rset.next())
				{
					...
					if(clanName != null)
					{
						...
						if(clan != null)
						{
							clan.addReputationScore(clan.getReputationScore() + 100, true);
