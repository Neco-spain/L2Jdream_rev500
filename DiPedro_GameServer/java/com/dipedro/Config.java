...
import com.dipedro.util.object.L2Properties;
import com.dipedro.util.services.ClassMasterSettings;
import com.dipedro.util.services.ConfigFiles;
...
public final class Config
{
	...
	public static void CustomConfig()
	{
		try
		{
            ...
            //AIO_ITEM2 = Integer.parseInt(p.getProperty("AioItem2", "4356"));
            //AIO_DIAS2 = Integer.parseInt(p.getProperty("AioDias2", "15"));
			if(ENABLE_AIO_SYSTEM)
			{
				...
				for (String skill : AioSkillsSplit)
					...
					else
					{
                       ...
                       VIP_ITEM = Integer.parseInt(p.getProperty("VipItem", "4356"));
	...
	public static void OlympiadConfig()
	{
		try
		{
			...
			String[] propertySplit = p.getProperty("AltOlyEndDate", "1").split(","); 
			...
			propertySplit = p.getProperty("AltOlyEndHour", "12:00:00").split(":"); 
			for (int i = 0; i < 3; i++) 
			{ 
	...
	public static void PhysicsConfig()
	{
		try
		{
			...
			BACKSTAB_ATTACK_FRONT = TypeFormat.parseInt(p.getProperty("BackstabAttackFront", "0"));
			BACKSTAB_ATTACK_SIDE = TypeFormat.parseInt(p.getProperty("BackstabAttackSide", "0"));
			BACKSTAB_ATTACK_BEHIND = TypeFormat.parseInt(p.getProperty("BackstabAttackBehind", "70"));
			/** Misc */
