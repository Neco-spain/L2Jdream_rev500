 ...
 */
package com.dipedro.gameserver.network;
...
import com.dipedro.gameserver.model.CharSelectInfoPackage;
...
import com.dipedro.gameserver.thread.LoginServerThread.SessionKey;
import com.dipedro.gameserver.thread.ThreadPoolManager;
import com.dipedro.gameserver.thread.daemons.AutoSave;
import com.dipedro.gameserver.util.FloodProtector;
import com.dipedro.mmocore.MMOClient;
import com.dipedro.mmocore.MMOConnection;
import com.dipedro.mmocore.ReceivablePacket;
...
public final class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> implements Runnable
{
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		_packetQueue = new ArrayBlockingQueue<ReceivablePacket<L2GameClient>>(com.dipedro.mmocore.Config.CLIENT_PACKET_QUEUE_SIZE);
