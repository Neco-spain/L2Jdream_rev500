...
import com.dipedro.gameserver.model.actor.instance.L2VillageMasterInstance;
...
import com.dipedro.gameserver.network.serverpackets.ShortCutRegister;
...
public class RequestAquireSkill extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		else if(_skillType == 2)
		{
			...
			player.getClan().addReputationScore(player.getClan().getReputationScore() - repCost, true);
