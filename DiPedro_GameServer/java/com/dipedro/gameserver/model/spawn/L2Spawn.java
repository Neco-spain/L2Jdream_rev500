 ...
 */
package com.dipedro.gameserver.model.spawn;
...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		_constructor = Class.forName("com.dipedro.gameserver.model.actor.instance." + implementationName + "Instance").getConstructor(parameters);
