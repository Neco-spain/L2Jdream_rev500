...
import com.dipedro.gameserver.updaters.CastleUpdater;
	...
	public void updateClansReputation()
	{
		...
		if (_formerOwner != null)
		{
			if (_formerOwner != ClanTable.getInstance().getClan(getOwnerId()))
			{
				...
				_formerOwner.takeReputationScore(1000, true);
				...
				if (owner != null)
				{
					owner.addReputationScore(Math.min(1000, maxreward), true);
			...
			{
				_formerOwner.addReputationScore(500, true);
		...
		else
		{
			...
			if (owner != null)
			{
				owner.addReputationScore(1000, true);
