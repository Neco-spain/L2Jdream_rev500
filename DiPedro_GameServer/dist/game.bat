...
java -Xmx1g -XX:+AggressiveOpts -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -XX:+CMSIncrementalPacing -XX:MaxPermSize=256m -XX:+HeapDumpOnOutOfMemoryError -cp ./lib/*;L2Dream.jar com.dipedro.gameserver.GameServer
